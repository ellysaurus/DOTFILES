...
let s:N1 = [ '#248813' , '#CAE682' , 232 , 192 ] " mode
let s:N2 = [ '#248813' , '#32322F' , 192 , 238 ] " info
let s:N3 = [ '#248813' , '#242424' , 192 , 235 ] " statusline
let s:N4 = [ '#248813' , 113 ]                   " mode modified
...
" Inactive mode
let s:IA = [ '#248813' , s:N3[1] , 243 , s:N3[3] , '' ]
